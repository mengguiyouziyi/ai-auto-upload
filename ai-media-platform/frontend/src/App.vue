      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
        <div class="sidebar">
          <div class="logo">
            ...
            <h2 v-show="!isCollapse">AI媒体智能平台</h2>
          </div>
          <el-menu
            :router="true"
          ...
          >
            ...
            <el-sub-menu index="ai">
              ...
              <el-menu-item index="/text-optimize">
                <el-icon><EditPen /></el-icon>
                <span>文本优化</span>
              </el-menu-item>
              <el-menu-item index="/video-generate">
                <el-icon><VideoPlay /></el-icon>
                <span>视频生成</span>
              </el-menu-item>
              <el-menu-item index="/audio-generate">
                <el-icon><Microphone /></el-icon>
                <span>语音合成</span>
              </el-menu-item>
              <el-menu-item index="/spider-tool">
...
import {
  ...
  Fold, Picture, Upload, Tools, Platform,
  EditPen, VideoPlay, Microphone, Connection
